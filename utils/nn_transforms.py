...
def aa2repr6d(rots):
    return quat2repr6d(aa2quat(rots))
...
def repr6d2aa(repr):
    return quat2aa(repr6d2quat(repr))
...
def rotation_6d_to_axis_angle(d6: torch.Tensor):
    """
    Convert rotations given as 6D rotation representation to axis/angles.
